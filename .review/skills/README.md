...
| --- | --- |
| `pr-review` | First-pass review of a diff. Hunts for the things that actually hurt in hypervisor code: guest-controlled values trusted too early, missing bounds and reference counting, locking and error paths that leave partial state, an assertion a guest can reach. Suggestions only. |
